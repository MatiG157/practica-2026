...
def actualizar_persona(id_persona, nombre, nacimiento, dni, altura):
    ...
    cursor.execute(
        ...
        WHERE IdPersona = ?
        """,
        (nombre, nacimiento.date().isoformat(), dni, altura, id_persona),
    )
    filas_afectadas = cursor.rowcount # rowcount es un atributo del cursor que devuelve el 
    #número de filas afectadas por la última operación de modificación (INSERT, UPDATE, DELETE) 
